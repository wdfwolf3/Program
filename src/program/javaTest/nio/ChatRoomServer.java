    ...
    public void dealWithSelectionKey(ServerSocketChannel server, SelectionKey sk) throws IOException {
        ...
        if (sk.isReadable()) {
            ...
            try {
                ...
                System.out.println(sc.getRemoteAddress() + " has left!");
                sk.cancel();
                if (sk.channel() != null) {
                    sk.channel().close();
                }
            ...
            if (content.length() > 0) {
                ...
                if (arrayContent != null && arrayContent.length == 1) {
                    ...
                    if (users.contains(name))
                        ...
                        System.out.println("client " + sc.getRemoteAddress() + " is registed, name is " + name);
                ...
                //注册完了，发送消息
                    ...
                    System.out.println("client " + name + "(" + sc.getRemoteAddress() + ") send data: " + message);
